...
| Field | Value |
|-------|--------|
| Series | Machine DNA — early sketches |
| Catalog path | `catalog/machine-dna-early-sketches/` |
| WIP sketches | `sketches/` (files listed in catalog series **machine-dna-early-sketches**) |

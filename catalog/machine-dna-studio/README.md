...
| Field | Value |
|-------|--------|
| Series | Machine DNA — studio system |
| Catalog path | `catalog/machine-dna-studio/` |
| WIP sketches | `sketches/machine-dna-studio/` |

## Live URL (hub)

https://mark-walhimer.com/sketches/emergent-dna/index.html

...
| Field | Value |
|-------|--------|
| Series | Prix Ars Electronica 2026 |
| Catalog path | `catalog/2026-ars-electronica/` |
| WIP sketches | `sketches/2026-ars-electronica/README.md` |

## Live URL (hub)

https://mark-walhimer.com/sketches/2026-ars-electronica/index.html

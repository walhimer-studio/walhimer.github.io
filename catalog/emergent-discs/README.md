...
| Field | Value |
|-------|--------|
| Series | Emergent Discs |
| Catalog path | `catalog/emergent-discs/` |
| WIP sketches | `sketches/emergent-discs/` |

## Live URL (hub)

https://mark-walhimer.com/sketches/emergent-discs/index.html
